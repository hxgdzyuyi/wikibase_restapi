...
defmodule WikibaseRESTAPI.Connection do
  @moduledoc """
  Handle Tesla connections for WikibaseRESTAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, WikibaseRESTAPI.Connection,
        base_url: "https://wikibase.example/w/rest.php/wikibase",
  ...
  @default_base_url Application.compile_env(
                      :wikibase_restapi,
                      :base_url,
                      "https://wikibase.example/w/rest.php/wikibase"
                    )
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:wikibase_restapi, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - WikibaseRESTAPI 1.0.0 - elixir"
        )
      )
